  ...
  (0, _createClass3.default)(SharedParams, [{
    ...
    value: function addParamListener(name, listener) {
      ...
      if (param) {
        ...
        if (param.type !== 'command') listener(param.value);
      } else {
